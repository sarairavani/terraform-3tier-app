...
variable "associate_public_ip" {
  description = "Whether to associate a public IP to the bastion instance"
  type        = bool
  default     = false
}
...
variable "user_data" {
  description = "Custom user data script for bastion instance (base64 encoded or empty to use default)"
  type        = string
  default     = ""
}
...
variable "enable_route53" {
  description = "Enable creating a private Route53 record for the bastion host"
  type        = bool
  default     = false
}
